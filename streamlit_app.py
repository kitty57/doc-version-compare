...
def main():
    st.set_page_config(page_title="Document Comparison", page_icon="", layout="wide", initial_sidebar_state="collapsed", menu_items={"Get Help": None, "Report a Bug": None})
    ...
    if uploaded_file_1 is not None and uploaded_file_2 is not None:
        with st.spinner("Processing..."):
            text_1 = uploaded_file_1.getvalue().decode("utf-8")
            text_2 = uploaded_file_2.getvalue().decode("utf-8")
