...
def main():
    ...
    question = "I've uploaded 2 documents doc1 and doc2 that explain 2 versions of the same document. Explaiin the changes that were introduced in the new version of the document."
